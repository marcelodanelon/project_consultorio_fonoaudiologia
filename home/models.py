...
class ClientModel(models.Model):
    ...
    zipcode = models.CharField(max_length=9,verbose_name='CEP', null=True, blank=True)
    street = models.CharField(max_length=50, verbose_name='Logradouro', null=True, blank=True)
    district = models.CharField(max_length=50, verbose_name='Bairro', null=True, blank=True)
    ...
    document1 = models.CharField(max_length=14, verbose_name='CPF', null=True, blank=True)
    document2 = models.CharField(max_length=12,verbose_name='RG', null=True, blank=True)
